            ...
            <div id="content">
                ...
                <form class="form-cadastro" action="cadastro.php" method="POST" enctype="multipart/form-data">
                            ...
                            <?php
                                ...
                                if (isset($_GET['msg2']) == 'personal_cadastrado') {
                                ...
                                if (isset($_GET['msg3']) == 'personal_nao_cadastrado') {
                                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <h6 style="color:white;">Usuario nao cadastrado!</strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
                            ...
                            <div class="col-xs-8 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <img id="output" src="../img/user.webp" class="img2 col-8" ></img>
                                ...
                                <div class="form-group flex-column col-9">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o nome do personal">
                                    </div>
                                    <div class="form-group col-12">
                                        <label for="inputAddress">Email</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Insira o email do personal">
                                    </div>
                                </div>
