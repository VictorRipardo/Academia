...
<head>
    ...
    <title>Academia Fit - Busca Personal</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link " href="cadbuscapersonal.php">
            ...
            <!-- Nav Item - cadastro personal -->
                <li class="nav-item">
                    <a class="nav-link " href="cadpersonal.php" >
                        <img src="../img/icon/personal.png" alt="personal">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                                ...
                                if (isset($_GET['msg2']) == 'personal_editado') {
                                    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <strong>Personal editado com sucesso! </strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
                                }
                                if (isset($_GET['msg3']) == 'personal_nao_editado') {
                                    echo '<div class=" w-80 alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>Personal nao editado!</strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
                                ...
                                if (isset($_GET['msg4']) == 'usuario_excluido') {
                                    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <strong>Personal excluido com sucesso! </strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
                                ...
                                if (isset($_GET['msg5']) == 'usuario_nao_excluido') {
                                    echo '<div class=" w-80 alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>Personal nao excluido!</strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
                ...
                <div class="busca w-80 " >
                    ...
                    <form class=" d-sm-inline-block form-inline w-100 navbar-search" method="POST">
                        <div class="input-group">
                            <input type="text" class="form-control1 form-control bg-light border-2 small" placeholder="Procure por um personal"
                                aria-label="Search" aria-describedby="basic-addon2" name="personal">
                ...
                <div class="col-xl-12 col-md-12 mb-12">
                    ...
                    <?php
                       ...
                       if(isset( $_POST['personal'])){
                            $busca = $_POST['personal'];

                            $sql = "SELECT * FROM tbpersonal where nome like '%$busca%' ";
                            ...
                            if ($resultado-> num_rows > 0) {
                                while ($linha = $resultado->fetch_array()) {
                                    ...
                                    echo '                        <div class="">'.'<img class="foto_usu1"src=" ' .$linha['foto_personal'].' ">'.'</div> ';
                                    echo '                        <div class=" col mr-2">'.$linha['nome'].'</div>';
                                    echo '                        <div class="col mr-2">'.$linha['email'].'</div>';
                                    echo '                        <div class="col mr-2">'.$linha['telefone'].'</div>';
                                    echo '                        <div class="col mr-2"><a href="edit.php?id='.$linha['id_adm'].' " '.'><button type="button"  class="btn btn-outline-success">Editar <i class="fa fa-edit"></i></button></a></div>';
                                    echo '                        <div class="col mr-2"><a href="excluir.php?id='.$linha['id_adm'].' " '.'><button type="button" class="btn btn-outline-danger">Excluir<i class="bi bi-trash-fill"></i></button></a></div>';
                                    echo '                    </div>';
                                    echo '                </div>';
                                    echo '            </div>';
                                    echo '        </div>';
                                ...
                                echo '<div class=" w-80 alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>Personal não encontrado!</strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>';
