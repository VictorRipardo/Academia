                ...
                <form class="form-cadastro" action="editSave.php" method="POST" enctype="multipart/form-data">
                            ...
                            <?php
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $id = $_GET['id'];
                                    $sql = "SELECT * from tbpersonal where id_adm = $id";
                            ...
                            <div class="col-xs-8 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php echo '<img id="output" src=" '.$linha['foto_personal'].'" class="img2 col-10" ></img> '; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="file" accept="image/*" class="form-control custom-file-input in" id="personal" name="personal" onchange="loadFile(event)">
                            ...
                            <input type="hidden" name="id" value= "<?php echo $linha['id_adm']; ?>">
