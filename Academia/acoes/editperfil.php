    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="form-cadastro" action="editperfilSave.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-8 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php echo '<img id="output" src=" '.$linha1['foto_personal'].'" class="img2 col-8" ></img> '; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="file" accept="image/*" class="form-control custom-file-input in" id="url_foto" name="personal" onchange="loadFile(event)">
                                ...
                                <div class="form-group flex-column col-9">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o nome do personal" value= "<?php echo $linha1['nome']; ?>">
                                    </div>
                                    <div class="form-group col-12">
                                        <label for="inputAddress">Email</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Insira o email do personal" value= "<?php echo $linha1['email']; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="senha" name="senha" placeholder="" value= "<?php echo $linha1['senha']; ?>">
                            </div>
                            
                            <div class="form-group col-md-12">
                                <label for="inputCity">Telefone</label>
                                <input type="tel" class="form-control" id="tel" name="tel" placeholder="(xx) xxxxx-xxxx" value= "<?php echo $linha1['telefone']; ?>">
                            </div>
