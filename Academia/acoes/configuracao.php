...
<head>
    ...
    <title>Academia Fit - Configurações</title>
                                ...
                                if(isset( $_SESSION['personal'])){
                                    ...
                                    if ($resultado-> num_rows > 0) {
                                        while ($linha = $resultado->fetch_array()) {
                                                ...
                                                echo '<a class="dropdown-item" href="sair.php" data-toggle="modal" data-target="#logoutModal"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>Sair</a>';
                                                echo '</div>';
                                                echo '</li>';
                        ...
                        <form class="d-sm-inline-block form-inline w-100 navbar-search"  method="POST" >
                            <div class="input-group">
                                <input type="text" class="form-control1 form-control bg-light border-2 small" placeholder="Procure um treino"
                                    aria-label="Search" aria-describedby="basic-addon2" name="inputBusca">
