...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <header class="py-2">
            ...
            <form class="form-cadastro1" action="editperfilSave.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-8 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="file" accept="image/*" class="form-control custom-file-input in" id="url_foto" name="usu" onchange="loadFile(event)">
                                ...
                                <div class="form-group1 flex-column col-9">
                                    <div class="form-group1 col-12">
                                        ...
                                        <input type="text" class="form-control1" id="nome" name="nome" placeholder="Insira o nome do personal" value= "<?php echo $linha1['nome']; ?>">
                                    </div>
                                    <div class="form-group1 col-12">
                                        <label for="inputAddress">Email</label>
                                        <input type="email" class="form-control1" id="email" name="email" placeholder="Insira o email do personal" value= "<?php echo $linha1['email']; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="form-group1 col-12">
                                ...
                                <input type="text" class="form-control1" id="senha" name="senha" placeholder="" value= "<?php echo $linha1['senha']; ?>">
                            </div>
                            
                            <div class="form-group1 col-md-12">
                                <label for="inputCity">Telefone</label>
                                <input type="tel" class="form-control1" id="tel" name="tel" placeholder="(xx) xxxxx-xxxx" value= "<?php echo $linha1['telefone']; ?>">
                            </div>
