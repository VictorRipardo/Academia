    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="form-cadastro" action="cadexercicio1.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <h3>cadastre um exercicio ao treino</h3>
                    </div>
                        ...
                        <div class="col-xs-8 col-sm-3 col-md-3 col-lg-3">
                            ...
                            <div class="form-group flex-column col-9">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o nome do treino">
                                </div>
                    ...
                    <div class="form-group ">
                                ...
                                <input type="number" class="form-control" id="series" name="series" placeholder="Insira a quantidade de series">
                            </div>
                            <div class="form-group ">
                                <label for="inputeNome">Quantidade de repetições</label>
                                <input type="number" class="form-control" id="repeticao" name="repeticao" placeholder="Insira a quantidade de repeticoes">
                            </div>
                    <div class="form-group">
