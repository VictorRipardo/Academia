    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <?php       
                            ...
                            <?php 
                                    ...
                                    $sql = "SELECT * FROM tbtreino where id_treino ='$id' ";
                ...
                <form class="form-cadastro" action="edit_treinoSave.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <h3>Edite o treino</h3>
                    </div>

                    <!-- Divider -->
                    <hr class="sidebar-divider d-none d-md-block">
                    <div class="form-group">
                        <label for="inputeNome">Nome do treino</label>
                        <input type="text" class="form-control" id="nometreino" name="nometreino" placeholder="Insira o nome do treino" value= "<?php echo $linha1['nome']; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="inputeMsg">Descrição</label>
                        <input type="text" class="form-control" name="desc" id="desc" placeholder="Descreva sobre o que é os exercicios do treino" value= "<?php echo $linha1['descricao']; ?>">
                        
                    </div>
                    <input type="hidden" name="id" value= "<?php echo $id ?>">

                    <div class="form-group2 col-md-6"> 
                        <button type="submit" class="btn btn-warning col-md-6">Editar treino</button>
                    </div>
