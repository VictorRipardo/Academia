    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="form-cadastro" action="cadtreino1.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nometreino" name="nometreino" placeholder="Insira o nome do treino">
                    </div>
                    
                    <div class="form-group">
                        <label for="inputeMsg">Descrição</label>
                        <textarea class="form-control" name="desc" id="desc" placeholder="Descreva sobre o que é os exercicios do treino"></textarea>
                        
                    </div>
                    <div class="form-group2 col-md-6"> 
                        <button type="submit" class="btn btn-warning col-md-6">Criar treino</button>
                    </div>
